So this code will allow you to select info on a particular agent in the MySQL database and the properties they are selling, based on the query setup in db.php.
